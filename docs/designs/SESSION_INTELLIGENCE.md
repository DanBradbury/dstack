...
gstack already writes structured artifacts to `./dstack/projects/$SLUG/`:
- CEO plans: `ceo-plans/`
...
the agent checks `./dstack/projects/$SLUG/` for recent plans, reviews, and
...
Plan: ./dstack/projects/$SLUG/checkpoints/latest.md"
