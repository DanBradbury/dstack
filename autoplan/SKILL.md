...
- Discover design docs: `ls -t ./dstack/projects/$SLUG/*-design-*.md 2>/dev/null | head -1`
...
- Test plan: generate artifact at `./dstack/projects/$SLUG/{user}-{branch}-test-plan-{datetime}.md`
...
- [ ] Test plan artifact written to disk at ./dstack/projects/$SLUG/
- [ ] "NOT in scope" section written
- [ ] "What already exists" section written
