 ...
 *
 * Resolution order:
 * 1. ./dstack/openai.json → { "api_key": "sk-..." }
...
/**
 * Save an API key to ./dstack/openai.json with 0600 permissions.
 */
...
export function requireApiKey(): string {
  ...
  if (!key) {
    ...
    console.error("  or save to ./dstack/openai.json: { \"api_key\": \"sk-...\" }");
